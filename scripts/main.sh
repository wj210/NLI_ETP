...
ds=multirc
nli_trained=True
for pct_train_rationales in 0.2
do  
    for seed in 42 
    do
        ...
        python main.py --gpu_no 0 --tasks $ds --plaus_weight 1.0 --seed $seed --min_one True --load_model True  --model_name_or_path $model_name --tokenizer_name_or_path $model_name --test_batch_size $batchsize --pct_train_rationales $pct_train_rationales --nli_trained $nli_trained --align True
        ## Ours (soft) 
